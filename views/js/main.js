...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
   ...
   // Take out this section because it's overly complicated and not needed
  ...
  function changePizzaSizes(size) {
    switch(size) {
      ...
      case "3":
        ...
        break;
      default:
        consol.log('Problem with changePizzaSizes function');
    }

    var randomPizzaSizes = document.querySelectorAll(".randomPizzaContainer");

    for (var i = 0; i < randomPizzaSizes.length; i++) {
      randomPizzaSizes[i].style.width = newWidth + "%";
    }
  }
...
// Get variable outside of the function
